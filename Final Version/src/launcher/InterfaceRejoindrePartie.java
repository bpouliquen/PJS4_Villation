...
public class InterfaceRejoindrePartie extends MovableJFrame {
	...
	public void remplirListeJoueur(final List<Joueur> listeJoueur) { //On recup la liste des joueurs depuis le serveur ?
		...
		liste.setCellRenderer(new DefaultListCellRenderer() {
			private static final long serialVersionUID = 1L;
			/**
			 * Permet de changer la couleur du joueur pour savoir si il est prêt ou non
			 */
			@Override
			public Component getListCellRendererComponent(JList<?> list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
				// Assumes the stuff in the list has a pretty toString
				setText(value.toString());
				// On change la couleur du texte en vert si le joueur est prêt, sino rouge
	...
	private GroupLayout hostMode() {
		...
		host_contentPanel.setHorizontalGroup(
			host_contentPanel.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(host_contentPanel.createSequentialGroup()
							...
							.addGroup(host_contentPanel.createParallelGroup(Alignment.LEADING)
								...
								.addGroup(host_contentPanel.createSequentialGroup()
									...
									.addPreferredGap(ComponentPlacement.RELATED)
									.addComponent(nPortLabel))
								.addGroup(host_contentPanel.createParallelGroup(Alignment.TRAILING, false)
									.addComponent(readyButton, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
									.addComponent(cancelButton, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
							.addPreferredGap(ComponentPlacement.RELATED, 26, Short.MAX_VALUE)))
					.addContainerGap())
		);
		host_contentPanel.setVerticalGroup(
			host_contentPanel.createParallelGroup(Alignment.TRAILING)
				.addGroup(host_contentPanel.createSequentialGroup()
					.addGap(4)
					.addComponent(partieNameLabel)
					...
					.addGroup(host_contentPanel.createParallelGroup(Alignment.LEADING, false)
						.addGroup(host_contentPanel.createSequentialGroup()
							...
							.addComponent(readyButton, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
							.addPreferredGap(ComponentPlacement.RELATED)
	...
	private GroupLayout joinMode() {
		...
		readyButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if(readyButton.getText().equals("Prêt")){
					//readyButton = new Button("ButtonPasPret.png", "ButtonPasPret.png", "Pas prêt", null);
		...
		join_contentPanel.setHorizontalGroup(
			join_contentPanel.createParallelGroup(Alignment.LEADING)
		...
		join_contentPanel.setVerticalGroup(
			join_contentPanel.createParallelGroup(Alignment.TRAILING)
				.addGroup(join_contentPanel.createSequentialGroup()
					.addGap(4)
					.addComponent(partieNameLabel)
					.addPreferredGap(ComponentPlacement.UNRELATED)
					.addGroup(join_contentPanel.createParallelGroup(Alignment.LEADING)
						.addGroup(Alignment.TRAILING, join_contentPanel.createSequentialGroup()
							.addComponent(readyButton, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(cancelButton, GroupLayout.PREFERRED_SIZE, 25, GroupLayout.PREFERRED_SIZE))
						.addComponent(scroll, GroupLayout.PREFERRED_SIZE, 120, GroupLayout.PREFERRED_SIZE))
